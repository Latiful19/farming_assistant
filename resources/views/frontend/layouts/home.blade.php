            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="#">Spices</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        ...
                        <p>Tips for Fruits & Vegetables</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            ...
                            <button data-filter=".top-featured">Top Retailer</button>
                            <button data-filter=".best-seller">Best Producer</button>
                        </div>
                    </div>
                </div>
            </div>
